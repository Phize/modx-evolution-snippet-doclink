...
$this->set('tplParent', '');
$this->set('tplFirst', '');
$this->set('tplPrev', '@CODE:<li class="previous enabled"><a href="[(base_uri)][+prev.uri+]" title="[+prev.title+]">&laquo;&nbsp;Previous</a></li>');
$this->set('tplNext', '@CODE:<li class="next enabled"><a href="[(base_uri)][+next.uri+]" title="[+next.title+]">Next&nbsp;&raquo;</a></li>');
$this->set('tplLast', '');
$this->set('tplHomeOff', '');
